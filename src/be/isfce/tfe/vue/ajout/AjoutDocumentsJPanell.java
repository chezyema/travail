...
public class AjoutDocumentsJPanell extends javax.swing.JPanel {
    ...
    private MaterielRoulant vehicules;
    ...
    public AjoutDocumentsJPanell(MaterielRoulant vehicule) {
        initComponents();
        this.vehicules = vehicule;
    }

    /**
     * This method is called from within the constructor to initialize the form.vehicule
    ...
    private void AjouterdocumentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AjouterdocumentActionPerformed
        ...
        DocumentAdministratif documents = ajoutDocumentsJPanell1.getDocumentFromFields();
        try {
            if (vehicules != null) {
                documents.setIdchauffeur(vehicules.getId());
            }
            new DocumentsAdministratifsControleur().controleEtAjoute(documents);
            dialogInterface.onButtonSavePressed();
        } catch (ValidationException ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
        }
